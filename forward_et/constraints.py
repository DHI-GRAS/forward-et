...
class VegConstraints(object):
    ...
    def __init__(self, datadict):
        ...
        self.Tmax = datadict['DASEMON_Tmax'][:]
        self.Tmin = datadict['DASEMON_Tmin'][:]
        self.NDVI = datadict['NDVI_16'][:]
        self.FPAR = datadict['fPAR'][:]

    def ft(self):
        """Calculate temperature constrain

        Notes
        -----
        This function calculates the temperature constrain.
        It accounts for the reduction in the photosintet efficiency when plants grow.
        Read further in Garcia et al under the methods section.
        Check table 2 for eqaution implemented. and assumptions.
        """
