...
"""
import glob
# Specify the folder you have your dictionary data in.
InputsFolder = 'D:\\Tutorial 7 -GMGO\\1.Radiation\\Dictionaries_Andalucia\\'
...
for inputfile in FileList:
    ...
    LST, ObsTime, Emissivity, AirMax, AirMin = fn.GetLongWaveRadiationInputs(
        Dictionary)

    Rlw_in, Tair_MODIS_passtime = rf.CalLongWave_Incoming_Parton_Logan(
        LST, ObsTime, N, AirMax, AirMin)
    ...
    ****************************************
    ...
    Fzang_all, Fdrying_all = Constraints.calSOILMoistureConstrain_f_Zhang(
        i, Fzang_all, Fdrying_all)
...
# It creates and output in the output folder
SaveActEvapotrans_Image(ActEvapotranspiration)
